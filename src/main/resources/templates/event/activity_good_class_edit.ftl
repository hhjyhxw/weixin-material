		...
		<fieldset class="layui-elem-field" style="width: 60%; text-align: center; margin-left: 20%;">
			...
			<div class="layui-form-item">
		  	...
		  	<div class="layui-form-item">
			    ...
			    <div class="layui-input-inline" style="width:70%">
			        <input type="text" name="sortNum" lay-verify="" value="${(record.goodImage)!'1'}" id="sortNum" placeholder="0" autocomplete="off" class="layui-input">
		  		</div>
		  		<div class="layui-form-mid layui-word-aux"><span style="color:red;"></span></div>
		  	</div>
		  	<div class="layui-form-item">
			    ...
			    <div class="layui-input-inline" style="width:70%">
			      	<select name="status" lay-verify="" id="status">
			      		...
			      		<option value="0" <#if (((record.status)!'') == '0')>selected="selected"</#if>>不显示</option>
				  		<option value="1" <#if (((record.status)!'') == '1')>selected="selected"</#if>>显示</option>
			      	</select>
		  		</div>
		  		<div class="layui-form-mid layui-word-aux"><span style="color:red;">*</span></div>
		  	</div>
	...
	layui.use('form', function(){
	  ...
	  form.on('submit(formDemo)', function(data){
		...
		if(categoriesId == ""){
	  	...
	  	document.actionForm.action="${request.contextPath}/goodclass/saveUpdate";

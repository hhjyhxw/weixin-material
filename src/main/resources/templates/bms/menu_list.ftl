	...
	<body>
			...
			<blockquote class="layui-elem-quote">
		       ...
		       <a href="javascript:;" class="layui-btn layui-btn-small" id="search">
				 ...
				 <a href="${request.contextPath}/admin/menu_to_input" class="layui-btn layui-btn-small" >
					...
					<table class="site-table table-hover">
						...
						<#list page.list as m>
						    <tr>
								...
								<td>
									<a href="${request.contextPath}/admin/menu_to_input?id=${m.id}"  class="layui-btn layui-btn-mini">编辑</a>
		...
		<script>
			...
			layui.use(['icheck', 'laypage','layer'], function() {
				...
				laypage({
					...
					jump: function(obj, first) {
						...
						if(!first) {
						 $.ajax({
				           url:'${request.contextPath}/admin/menu_getlist',
				           type:'post',
				           ...
				           debugger
                            ...
                            $.each(data.list,function(i,val){
								...
								str += '<td>'
								str += '<a href="${request.contextPath}/admin/menu_to_input?id='+val.id+'"  class="layui-btn layui-btn-mini">编辑</a>'
			...
			function del(id){
			         $.ajax({
				           url:'${request.contextPath}/admin/menu_del',
				           type:'post',
				           data:{"id":id},
				           success:function(data) { 
				              layer.msg("删除成功",{time:2000});
				              setTimeout(function(){window.location.href="${request.contextPath}/admin/menu_list";},1000);
